![Aurora do42](https://i.imgur.com/PNRXfCUh.jpg)

# Aurora do42
The Aurora do42 is a redesign by splitkb.com of the popular do42 by Naoki Katahira.
...
Make example for this keyboard (after setting up your build environment):
    ...
    make splitkb/aurora/do42/rev1:default

Example of flashing this keyboard:

    make splitkb/aurora/do42/rev1:default:flash
...
# Features
The Aurora do42 supports the following features:
