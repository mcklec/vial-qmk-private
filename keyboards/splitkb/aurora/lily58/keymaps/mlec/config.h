...
#define RGBLIGHT_TIMEOUT 15000  // ms to wait until rgblight time out, 900K ms is 15min.

#define OLED_TIMEOUT 1500 // ms to wait until rgblight time out, 900K ms is 15min.
